...
resolve_snapshot_version() {
    snapshot_api_url="https://api.github.com/repos/aomtest/komari-slim-agent/releases?per_page=100"
...
if [ -n "$github_proxy" ]; then
    ...
    download_url="${github_proxy}/https://github.com/aomtest/komari-slim-agent/releases/${download_path}/${file_name}"
else
    # Direct access to GitHub releases
    download_url="https://github.com/aomtest/komari-slim-agent/releases/${download_path}/${file_name}"
fi
